...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", path: "scripts/1-install.sh"
  config.vm.provision "shell", path: "scripts/2-install-grafana.sh"
  config.vm.provision "shell", path: "scripts/3-node-exporter.sh"
